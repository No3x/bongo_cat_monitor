...
class BongoCatSettingsGUI:
    ...
    def create_display_tab(self, notebook):
        ...
        self.widgets['show_gpu_usage'] = tk.BooleanVar(self.window)
        ttk.Checkbutton(display_group, text="Show GPU Usage", 
                       variable=self.widgets['show_gpu_usage'], command=self.on_setting_changed).pack(anchor='w', pady=2)
    ...
    def load_current_settings(self):
        ...
        try:
            ...
            self.widgets['show_gpu_usage'].set(display.get('show_gpu_usage', True))
    ...
    def _save_apply_settings(self, close_window=False):
        ...
        try:
            ...
            self.config.set_setting('display', 'show_gpu_usage', self.widgets['show_gpu_usage'].get())
