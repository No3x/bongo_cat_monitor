...
Bongo Cat is a cute digital pet that lives on your desk and types along with you! This ESP32-based project displays a charming cat that responds to your typing speed, shows system statistics (CPU, GPU, RAM, CPU temperature, GPU temperature, WPM), and features adorable animations that bring joy to your workspace.

## ✨ Features

- **Real-time Typing Detection** - Cat types faster when you type faster
- **System Monitoring** - Displays CPU usage, GPU usage, RAM usage, CPU temperature (requires admin rights), GPU temperature and current time
